...
export const timeline = [
  ...
  },
  {
    ...
    time: '17:00 — 19:00',
    place: '인계동 나혜석거리',
    title: '시원한 한 잔에 담은 마음',
    body: '8월의 마지막 토요일, 태극기가 펄럭이는 천막 아래에서 시원한 음료를 만들고 간식을 준비했습니다. 광장의 목소리 곁에 서로를 챙기는 손길도 함께 담긴 열두 번째 현장입니다.',
    posters: [
  ...
  },
  {
    ...
    time: '17:00 — 19:00',
    place: '인계동 나혜석거리',
    title: '9월의 첫 토요일, 다시 거리에서',
    body: '달력이 9월로 넘어가고, 나혜석거리에는 다시 천막과 태극기가 자리했습니다. 오후 햇살이 비치던 거리부터 가게 불빛이 켜진 저녁까지, 참가자들은 손팻말을 들고 열세 번째 행동을 이어갔습니다.',
    posters: [
  ...
  },
  {
    ...
    time: '17:00 — 19:00',
    place: '인계동 나혜석거리',
    title: '익숙한 분수 곁, 변함없이 든 태극기',
    body: '흐린 하늘 아래, 나혜석거리 분수 곁으로 커다란 태극기가 펼쳐졌습니다. 오가는 시민들 사이에서 다시 같은 자리에 선 참가자들이 열네 번째 토요일의 기록을 남겼습니다.',
    posters: [
    ...
    photos: [
      { src: '/images/history/session-14/field-01.webp', width: 1920, height: 897, alt: '나혜석거리 천막 앞에서 태극기를 들고 함께한 14회차 참가자들', label: '태극기와 함께한 14회차' },
